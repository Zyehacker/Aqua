      ...
      <section className="home-hero" aria-label="Quick launch">
        <div className="home-hero__content">
          {loading ? (
            ...
            <div className="home-hero__empty"><p className="home-hero__eyebrow">Aqua Client</p><h1>{t('common.noInstances')}</h1><p>{t('common.createToStart')}</p><Link to="/instances" className="btn btn-aqua btn-lg home-hero__launch"><Plus size={18} />{t('common.createInstance')}</Link></div>
          ) : (
            <div className="home-hero__instance">
              <p className="home-hero__eyebrow">{t('common.currentInstance')}</p>
